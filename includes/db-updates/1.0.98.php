...
function btr_update_database_1_0_98() {
    ...
    try {
        ...
        $tables_created = [
            $wpdb->get_var("SHOW TABLES LIKE '$table_payment_plans'") === $table_payment_plans,
            $wpdb->get_var("SHOW TABLES LIKE '$table_group_payments'") === $table_group_payments,
            $wpdb->get_var("SHOW TABLES LIKE '$table_payment_reminders'") === $table_payment_reminders
        ];
