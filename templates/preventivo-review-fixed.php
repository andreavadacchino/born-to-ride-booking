...
$totale_persone = intval( get_post_meta( $preventivo_id, '_num_adults', true ) ) + 
                  intval( get_post_meta( $preventivo_id, '_num_children', true ) ) + 
                  intval( get_post_meta( $preventivo_id, '_num_neonati', true ) );
