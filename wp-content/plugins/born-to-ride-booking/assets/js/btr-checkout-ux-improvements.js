...
(function($) {
    ...
    class BTRCheckoutUX {
        ...
        loadFormData() {
            try {
                // FIX v1.0.226: Valida cache prima del caricamento
                ...
                // Se preventivo diverso, non caricare cache corrotta
                if (preventivo_id && preventivo_id !== lastPreventivoId) {
                    console.log("[BTR UX] Cache non valida per preventivo", preventivo_id, "vs", lastPreventivoId);
                ...
                console.log("[BTR UX] Caricamento dati validati dalla cache...");
                
                // Restore form data                    // Handle room selections
        ...
        /**
         * Migliora UX per checkbox assicurazioni
         * Permette di cliccare sull'intero item per selezionare la checkbox
         */
        improveCheckboxLabels() {
            // Inizializza visual state per checkbox già selezionate al load
            $('.btr-assicurazione-item').each(function() {
                const $item = $(this);
            ...
            // Click su .btr-assicurazione-item seleziona/deseleziona la checkbox
            $(document).on('click', '.btr-assicurazione-item', function(e) {
                // Non intervenire se si clicca direttamente sulla checkbox
                ...
                if ($checkbox.length) {
                    ...
                    // Trigger change event per aggiornare calcoli
            ...
            // Migliora visual feedback per checkboxes esistenti
