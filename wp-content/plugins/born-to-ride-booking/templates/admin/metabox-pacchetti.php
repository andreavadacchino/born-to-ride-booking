    ...
    <div class="btr-meta-box-container">
        <div class="meta-box-sidebar">
            <ul class="meta-box-tabs">
                ...
                <li data-tab="payment">Condizioni Pagamento</li>
        ...
        <div class="meta-box-content">
            ...
            <div id="payment" class="tab-content" role="tabpanel">
                <?php include BTR_PLUGIN_DIR.'templates/admin/metabox-pacchetto-tab/payment.php'; ?>
            </div>
