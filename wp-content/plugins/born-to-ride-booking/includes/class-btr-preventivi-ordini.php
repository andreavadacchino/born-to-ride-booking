...
class BTR_Preventivo_To_Order
{
    ...
    public function __construct()
    {
        ...
        // FIX v1.0.236: Aggiungi handler AJAX mancanti per chiamate JavaScript
        add_action('wp_ajax_btr_convert_to_checkout', [$this, 'convert_to_checkout']);
        add_action('wp_ajax_nopriv_btr_convert_to_checkout', [$this, 'convert_to_checkout']);
        add_action('wp_ajax_btr_goto_anagrafica_compile', [$this, 'goto_anagrafica_compile']);
        add_action('wp_ajax_nopriv_btr_goto_anagrafica_compile', [$this, 'goto_anagrafica_compile']);
