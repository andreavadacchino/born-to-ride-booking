...
class BTR_Database_Migration {
    ...
    private static function backup_before_migration($version) {
        ...
        try {
            foreach ($tables_to_backup as $table) {
                // Verifica se la tabella esiste - use prepared statement
                ...
                // Crea backup - Sanitize table names to prevent SQL injection
                ...
                $wpdb->query("INSERT INTO `{$sanitized_backup_table}` SELECT * FROM `{$sanitized_table}`");
    ...
    public static function get_history($limit = 50) {
        ...
        // Verifica se tabella esiste - use prepared statement
        ...
        return $wpdb->get_results($wpdb->prepare("
            SELECT * FROM `{$sanitized_log_table}` 
    ...
    public static function clean_old_backups($days_to_keep = 30) {
        ...
        // Pattern per trovare tabelle backup - use prepared statement
