...
class BTR_Payment_Cron_Manager {
    ...
    public function expire_old_payments() {
        ...
        // Find expired payments - TEMPORANEAMENTE DISABILITATO (colonna expires_at non esiste)
        $expired_payments = [];
    ...
    public function process_auto_cancellations() {
        ...
        // Find payments that should be auto-cancelled - TEMPORANEAMENTE DISABILITATO (colonna auto_cancel_at non esiste)
        $payments_to_cancel = [];
